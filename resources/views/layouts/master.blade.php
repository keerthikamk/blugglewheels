...
<head>
  ...
  <title>BluggleWheels - Travel Booking Agency</title>
  <link rel="icon" type="/image/x-icon" href="/assets/img/logoicon.png">
...
<a href="tel:9150259204" class="phone-float"  style="vertical-align: middle;font-size: 22px !important;">
<!-- <a href="tel:+919659440038" class="nav-link"><i class="fa-solid fa-phone me-2 fs-3 icons" style="vertical-align: middle;font-size: 22px !important;"></i><span>9150259204<span></a> -->
	<i class="fa fa-phone my-phone-float"></i>
</a>

<a href="https://api.whatsapp.com/send?phone=919150259204&text=Hola%21%20Quisiera%20m%C3%A1s%20informaci%C3%B3n%20sobre%20Varela%202." class="float" target="_blank">
...
<body>
	...
	<div id="main-wrapper">
			...
			<div class="container">
				<nav id="navigation" class="navigation navigation-landscape">
					<div class="nav-header">
						<a class="nav-brand static-show" href="/"><img src="/assets/img/logowhite.png" class="logo" alt=""></a>
						<a class="nav-brand mob-show" href="/"><img src="/assets/img/logoblack.png" class="logo" alt=""></a>
						<div class="nav-toggle"></div>
						<div class="mobile_nav">
							<ul>
								<!-- <li class="currencyDropdown me-2">
									<a href="home-2.html#" class="nav-link" data-bs-toggle="modal" data-bs-target="#currencyModal"><span
											class="fw-medium">INR</span></a>
								</li>
								<li class="languageDropdown me-2">
									<a href="home-2.html#" class="nav-link" data-bs-toggle="modal" data-bs-target="#countryModal"><img
								...
								<li>
									<!-- <a href="/contact" class="bg-light-danger text-danger rounded">Enquire Now</a> -->
									<a href="/contact" class="bg-light-danger text-danger rounded">Book Now</a>
								</li>
							</ul>
						</div>
					</div>
              ...
              <li class="dropdown nav-item" id="home"><a class="nav-link" href="/">Home</a></li>
			  <li class="dropdown nav-item" id="about-us"><a class="nav-link" href="/about-us">About</a></li>
			  <li class="dropdown nav-item" id="services"><a class="nav-link" href="/services">Services</a></li>
              
              
              <li><a href="JavaScript:Void(0);">Car Rental<span class="submenu-indicator"></span></a>
								<ul class="nav-dropdown nav-submenu">
									<li>
										<a href="/cars/sedan">Sedan <i><class="ms-2"></i><img src="/assets/images/icon/iseda.png"></a>
									</li>
									<li>						
										<a href="/cars/suv">Suv <i><class="ms-2"></i><img src="/assets/images/icon/isuvv.png"></a>
									</li>
									<li>
										<a href="/cars/hatchback">hatchback <i><class="ms-2"></i><img src="/assets/images/icon/ihbk.png"></a>
									</li> 
									<!-- <li>
										<a href="/cars/kn">kn</a>
									</li>  -->
			  ...
			  <!-- <li class="dropdown nav-item" id="tour-package"><a class="nav-link" href="/tour-package">Tour packages</a></li> -->
			  <!-- <li class="dropdown nav-item" id="outstationtrip"><a class="nav-link" href="/outstationtrip">Out station trips</a></li> -->
              <li class="dropdown nav-item" id="gallery"><a class="nav-link" href="/gallery">Gallery</a></li>
              <li class="dropdown nav-item" id="contact"><a class="nav-link" href="/contact">Contact Us</a></li>
						...
						<ul class="nav-menu nav-menu-social align-to-right">
							...
							<li class="list-buttons">
								...
								<button class=" nav-link btn btn-md btn-light-primary fw-medium me-2">Book Now</button>
							</li>
						...
						<div class="col-lg-6 col-md-6">
							<div class="footer-widget">
								<div class="d-flex align-items-start flex-column mb-3">
									<div class="d-inline-block"><img src="/assets/img/logowhite.png" class="img-fluid" width="160"
											alt="Footer Logo"></div>
								</div>
						...
						<div class="col-lg-6 col-md-6">
							<div class="footer-widget">
								...
								<ul class="footer-menu">
									...
									<li><a href="/#rate-card">Car Rentals</a></li>
				...
				<div class="container">
					<div class="row align-items-center justify-content-between">
						...
						<div class="col-xl-6 col-lg-6 col-md-6">
							<!-- <p class="mb-0">© 2024 BluggleWheels Design by BluggleGroups.</p> -->
							<p class="mb-0"> &copy;<span id="copyright"> <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script></span> <a href="/">BluggleWheels </a> Designed By<a href="https://blugglegroups.com/" target="_blank" style="color:white"><u> BLUGGLE GROUPS.</u></a></p>
						</div>
			...
			<div class="modal-dialog modal-dialog-centered login-pop-form" role="document">
				<div class="modal-content" id="loginmodal">
					<div class="modal-header">
						...
						<a href="home-2.html#" class="text-muted fs-4" data-bs-dismiss="modal" aria-label="Close"><i
					...
					<div class="modal-body">
						...
						<div class="social-login py-4 px-2">
							<ul class="row align-items-center justify-content-between g-3 p-0 m-0">
								...
								<li class="col"><a href="home-2.html#" class="square--60 border br-dashed rounded-2"><i
				  ...
				  <div class="suggestedCurrencylist-wrap mb-4">
					...
					<div class="suggestedCurrencylists">
					  <ul
						...
						<li class="col">
						  <a class="selectCurrency" href="home-2.html#">
						...
						<li class="col">
						  <a class="selectCurrency active" href="home-2.html#">
				  ...
				  <div class="suggestedCurrencylist-wrap mb-4">
					...
					<div class="suggestedCurrencylists">
					  <ul
						...
						<li class="col">
						  <a class="selectCountry" href="home-2.html#">
						...
						<li class="col">
						  <a class="selectCountry active" href="home-2.html#">
		...
		<!-- <a id="back2Top" class="top-scroll" title="Back to top" href="home-2.html#"><i class="fa-solid fa-sort-up"></i></a> -->
    ...
    <?php
        ...
        $path = explode("/", $path);
    ?>
    <script>document.getElementById('{{ $path[0] }}').classList.add("active");</script>
