...
@section('content')
		...
		<section class="bg-cover position-relative" style="background:url(/assets/img/se1.jpg)no-repeat;" data-overlay="5">
			<div class="container">
					...
					<div class="col-xl-7 col-lg-9 col-md-12">
						...
						<div class="fpc-capstion text-center my-4">
							<div class="fpc-captions">
								<h1 class="xl-heading text-light">Maruti Dzire</h1>
								<p class="text-light">Sedan</p>
							</div>
						</div>
		...
		<!-- <section class="bg-cover position-relative" style="background:url(assets/img/banner-7.jpg)no-repeat;" data-overlay="5">
			<div class="container">
				<div class="row align-items-center justify-content-center">
					<div class="col-xl-7 col-lg-9 col-md-12">
				...
				<div class="row">
									...
									<div class="col-xl-8 col-lg-7 col-md-12">
										<div class="galleryGrid typeGrid_2 mb-lg-0 mb-3">
											<div class="galleryGrid__item relative d-flex">
												<a href="/assets/img/md11.jpg" data-lightbox="roadtrip"><img src="/assets/img/md11.jpg"
														alt="image" class="rounded-2 img-fluid"></a>
											</div>

											<div class="galleryGrid__item position-relative">
												<a href="/assets/img/md-3.jpg" data-lightbox="roadtrip"><img src="/assets/img/md-3.jpg"
														alt="image" class="rounded-2 img-fluid"></a>
											...
											<div class="galleryGrid__item">
												<a href="/assets/img/md-1.jpg" data-lightbox="roadtrip"><img src="/assets/img/md-1.jpg"
														alt="image" class="rounded-2 img-fluid"></a>
											</div>
											<div class="galleryGrid__item">
												<a href="/assets/img/md-2.jpg" data-lightbox="roadtrip"><img src="/assets/img/md-2.jpg"
														alt="image" class="rounded-2 img-fluid"></a>
											</div>
										</div>
									</div>
										...
										<div class="card border br-dashed">
											<div class="card-header">
												<div class="crd-heady102 d-flex align-items-center justify-content-start">
													...
													<div class="title">
														<h4><i class="fa-solid fa-file-invoice-dollar me-2"></i>Rate Card</h4>
													</div>
												...
												<div class="d-block">
													...
													<div class="form-group mb-3">
														<div class="d-flex align-items-center justify-content-between">
															<div class="crd-heady102 d-flex align-items-center justify-content-start">
																<div class="square--30 circle bg-light-info text-info"><i class="fa-solid fa-clock"></i></div>
																<div class="crd-heady102Title lh-1 ps-2"><span class="text-dark lh-1 mb-0">4Hrs/40kms</span></div>
															</div>
															<div class="crd-heady103">
																<span class="text-dark text-uppercase">1200</span>
															</div>
														</div>
													</div>
													...
													<div class="form-group mb-3">
														<div class="d-flex align-items-center justify-content-between">
															<div class="crd-heady102 d-flex align-items-center justify-content-start">
																<div class="square--30 circle bg-light-info text-info"><i class="fa-solid fa-clock"></i></div>
																<div class="crd-heady102Title lh-1 ps-2"><span class="text-dark lh-1 mb-0">8Hrs/80kms</span></div>
															</div>
															<div class="crd-heady103">
																<span class="text-dark text-uppercase">2400</span>
															</div>
														</div>
													</div>
													...
													<div class="form-group mb-3">
														<div class="d-flex align-items-center justify-content-between">
															<div class="crd-heady102 d-flex align-items-center justify-content-start">
																<div class="square--30 circle bg-light-info text-info"><i class="fa-solid fa-user"></i></div>
																<div class="crd-heady102Title lh-1 ps-2"><span class="text-dark lh-1 mb-0">Seaters</span></div>
															</div>
															<div class="crd-heady103">
																<span class="text-dark text-uppercase">4+1</span>
															</div>
														</div>
													</div>
													...
													<div class="form-group mb-3">
														<div class="d-flex align-items-center justify-content-between">
															<div class="crd-heady102 d-flex align-items-center justify-content-start">
																<div class="square--30 circle bg-light-info text-info"><i class="fa-solid fa-road"></i></div>
																<div class="crd-heady102Title lh-1 ps-2"><span class="text-dark lh-1 mb-0">Additional Kms</span></div>
															</div>
															<div class="crd-heady103">
																<span class="text-dark text-uppercase">30</span>
															</div>
														</div>
													</div>
													...
													<div class="form-group mb-3">
														<div class="d-flex align-items-center justify-content-between">
															<div class="crd-heady102 d-flex align-items-center justify-content-start">
																<div class="square--30 circle bg-light-info text-info"><i class="fa-solid fa-clock"></i></div>
																<div class="crd-heady102Title lh-1 ps-2"><span class="text-dark lh-1 mb-0">Additional Hrs</span></div>
															</div>
															<div class="crd-heady103">
																<span class="text-dark text-uppercase">300</span>
															</div>
														</div>
													</div>
													...
													<div class="form-group mb-3">
														<div class="d-flex align-items-center justify-content-between">
															<div class="crd-heady102 d-flex align-items-center justify-content-start">
																<div class="square--30 circle bg-light-info text-info"><i class="fa-solid fa-hotel"></i></div>
																<div class="crd-heady102Title lh-1 ps-2"><span class="text-dark lh-1 mb-0">Outstation Add perKM</span></div>
															</div>
															<div class="crd-heady103">
																<span class="text-dark text-uppercase">15</span>
															</div>
														</div>
													</div>
													...
													<div class="form-group mb-3">
														<div class="d-flex align-items-center justify-content-between">
															<div class="crd-heady102 d-flex align-items-center justify-content-start">
																<div class="square--30 circle bg-light-info text-info"><i class="fa-solid fa-hotel"></i></div>
																<div class="crd-heady102Title lh-1 ps-2"><span class="text-dark lh-1 mb-0">Outstation min 250KM</span></div>
															</div>
															<div class="crd-heady103">
																<span class="text-dark text-uppercase">3750</span>
															</div>
														</div>
													</div>
													...
													<div class="form-group mb-3">
														<div class="d-flex align-items-center justify-content-between">
															<div class="crd-heady102 d-flex align-items-center justify-content-start">
																<div class="square--30 circle bg-light-info text-info"><i class="fa-solid fa-money-bill"></i></div>
																<div class="crd-heady102Title lh-1 ps-2"><span class="text-dark lh-1 mb-0">Driver Batta/day</span></div>
															</div>
															<div class="crd-heady103">
																<span class="text-dark text-uppercase">₹500</span>
															</div>
														</div>
													</div>
													...
													<div class="form-group mb-2">
														<a href="/contact">
														<button type="button" class="btn btn-primary full-width fw-medium">Book Now</button>
														</a>
													</div>
												</div>
											</div>
					...
					<!-- <div class="col-xl-12 col-lg-12 col-md-12"> -->
						...
						<!-- <div class="card mb-4">
							...
							<div class="card-body">
								<p class="mb-0">Blugglewheels offers a diverse range of vehicles to suit every traveler's needs, from compact cars for city drives to spacious SUVs for adventurous road trips. Each car is meticulously maintained and equipped with modern amenities to ensure a comfortable and safe journey across India. Whether you're planning a short getaway or an extended exploration, Blugglewheels provides the perfect car to make your travel experience seamless and enjoyable.</p>
							</div>
						</div> -->
					<!-- </div> -->
										...
										<ul class="row align-items-center p-0 mb-0 gx-4 gx-lg-5">
											...
											<li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
												<div class="d-flex align-items-center justify-content-between mb-3">
													...
													<span class="fw-medium text-muted">Maruti Dzire</span>
												</div>
											</li>
											<!-- <li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
												<div class="d-flex align-items-center justify-content-between mb-3">
					...
					<div class="col-xl-6 col-lg-12 col-md-12">
						<div class="card mb-4">
							<div class="card-header">
								<h4 class="fs-5 mb-0">Exclusions</h4>
							</div>
							<div class="card-body">
						...
						<div class="card mb-4">
							...
							<div class="card-body">
								<div class="expott-info mb-4">
									...
									<ul class="row align-items-center p-0 g-3">
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>Maximum 4 passenger capacity for Sedan.
										</li>
										<!-- <li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>Maximum 7 passenger capacity for SUV
										</li> -->
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>Minimum 250km coverage for round trip.
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>One day Round trip close by 10pm at ur pickup.
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>Waiting charges Rs.150 per hour in between ur trip.
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>Food break, tea break, & rest room no waiting chrgs.
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>Cancellation charges Rs.300 after driver arrived.
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>Luggage load in carrier Rs.300 if Mention in QT.
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>Note down starting and ending km is must.
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>Permit charges and Driver Bata is same as quoted.
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>Toll charges will be paid thru fastag by Driver.
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>EOT calculated running km, Toll by fastag & rest all.
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>Toll fees, interstate Permit, Hill charges pet charges waiting charges (if any) are extra.
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>1 day means 1 calendar day(from midnight 12 to next midnight 12).
										</li>
									</ul>
								</div>
								<!-- <div class="expott-info">
