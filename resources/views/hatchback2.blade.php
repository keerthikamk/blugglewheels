...
<section class="bg-cover position-relative" style="background:url(/assets/img/hb2.jpg)no-repeat;" data-overlay="5">
			<div class="container">
					...
					<div class="col-xl-7 col-lg-9 col-md-12">
						...
						<div class="fpc-capstion text-center my-4">
							<div class="fpc-captions">
								<h1 class="xl-heading text-light">Maruti Wagon R</h1>
									...
									<div class="col-xl-8 col-lg-7 col-md-12">
										<div class="galleryGrid typeGrid_2 mb-lg-0 mb-3">
											<div class="galleryGrid__item relative d-flex">
												<a href="/assets/img/wag3.jpg" data-lightbox="roadtrip"><img src="/assets/img/wag3.jpg"
														alt="image" class="rounded-2 img-fluid"></a>
											</div>

											<div class="galleryGrid__item position-relative">
												<a href="/assets/img/wag4.jpg" data-lightbox="roadtrip"><img src="/assets/img/wag4.jpg"
														alt="image" class="rounded-2 img-fluid"></a>
											...
											<div class="galleryGrid__item">
												<a href="/assets/img/wag1.jpg" data-lightbox="roadtrip"><img src="/assets/img/wag1.jpg"
														alt="image" class="rounded-2 img-fluid"></a>
											</div>
											<div class="galleryGrid__item">
												<a href="/assets/img/wag2.jpg" data-lightbox="roadtrip"><img src="/assets/img/wag2.jpg"
														alt="image" class="rounded-2 img-fluid"></a>
											</div>
										</div>
									</div>
									...
									<div class="col-xl-12 col-lg-12 col-md-12">
										<ul class="row align-items-center p-0 mb-0 gx-4 gx-lg-5">
											...
											<li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<span class="fw-medium text-dark">Modal</span>
													<span class="fw-medium text-muted">Maruti Wagon R</span>
												</div>
											</li>
											<!-- <li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
												<div class="d-flex align-items-center justify-content-between mb-3">
